...
public class GridLengthAnimation : AnimationTimeline
{
    ...
    public override object GetCurrentValue(object defaultOriginValue, object defaultDestinationValue, AnimationClock animationClock)
    {
        ...
        if (fromVal > toVal)
        {
            return new GridLength((1 - animationClock.CurrentProgress.GetValueOrDefault()) * (fromVal - toVal) + toVal, GridUnitType.Pixel);
        }

        return new GridLength(animationClock.CurrentProgress.GetValueOrDefault() * (toVal - fromVal) + fromVal, GridUnitType.Pixel);
    }
